            ...
            <div class="row" style="min-height: 100vh;">
                <div class="col-12 col-lg-4 text-center d-flex flex-column" style="background-color: #F2C98A;">
                    <div>
                        ...
                        <h3 class="font-weight-bolder text-center my-5" style="color: #986923;">There's only one thing that matters
                        <br />Customer Satisfaction</h3>
                    </div>
                ...
                <div class="col-12 col-lg-8 d-flex flex-column">
                    ...
                    <div class="container my-5" style="max-width: 60rem;">
                        ...
                        <form action="{{ route($app->module.'.public') }}" class="mt-5">
                            ...
                            <h5 class="text-muted mt-5">Enter your Phone Number:</h5>
